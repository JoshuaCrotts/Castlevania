...
public class GUI extends JComponent {
    ...
    private static final ArrayList<Rectangle> playerHealthBar = new ArrayList<Rectangle>();
    private static final ArrayList<Rectangle> bossHealthBar = new ArrayList<Rectangle>();
    ...
    /**
     * This method removes a rectangle dependent on the player's health, and has
     * a text version of the health running in the console, and if that is
     * divisible by 100 evenly, it removes a health bar.
     */
