...
public class Player extends JComponent {
    ...
    public Player(int x, int y) {
        ...
        this.y = y;
        health = 10;
        items = new ArrayList<>(); // for items gathered in game
        setFocusable(true);
    }
    ...
    /**
     * Checks to see if the method needs to repaint, if the old image equals the
     * new image.
     *
     ...
     *
     * @return true if y plus the height of the character is clear of obstacles,
     * false otherwise.
     */
