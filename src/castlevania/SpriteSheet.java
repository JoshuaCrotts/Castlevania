...
public class SpriteSheet {
    ...
    /**
     * Basically, this class makes the sprite sheets for the enemies. It will be
     * a 2D array for both the regular images and flipped images. There is a
     * method to rotate the images.
     *
    ...
    /**
     * Modifies a row at given parameters @row && @col Modifies them to size
